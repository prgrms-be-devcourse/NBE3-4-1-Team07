...
interface ProductListProps {
    ...
    onProductDeleteClick: (id: number) => void;
}
            ...
            {products.map((product) => (
                <li key={product.id}
                    ...
                    <div className="flex space-x-2">
                        ...
                        <button
                            className="px-4 py-2 bg-red-800 text-white rounded hover:bg-gray-700 transition"
                            onClick={() => onProductDeleteClick(product.id)}
                        >
                            삭제
                        </button>
                    </div>
